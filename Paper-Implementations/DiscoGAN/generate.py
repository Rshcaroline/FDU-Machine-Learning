...
parser.add_argument('--outf', default='samples/our_data_600/iter900', help='folder to output images and model checkpoints')
...
parser.add_argument('--G_AB', default='checkpoints/our_data_600/G_AB_900.pth', help='path to pre-trained G_AB')
parser.add_argument('--G_BA', default='checkpoints/our_data_600/G_BA_900.pth', help='path to pre-trained G_BA')
