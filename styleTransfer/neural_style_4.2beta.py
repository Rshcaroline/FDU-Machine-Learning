...
def style_transfer(style_file, content_file, trick, num_steps,
    ...
    imsave(input_img.data, title='Input_{}_{}'.format(content_file[:7], trick))
    imsave(style_img.data, title='Input_{}'.format(style_file[:5]))
...
# final API
style_transfer(style_file='style2.png',
